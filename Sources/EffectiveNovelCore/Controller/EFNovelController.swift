  ...
  public func start(script: EFNovelScript) -> AnyPublisher<DisplayEvent, Never> {
    switch state {
      case .prepare:
        ...
        startLoop()
      default:
        print("current state must be prepare. it is \(state)")
    }
  ...
  public func interrupt() {
    switch state {
      case .running, .pause:
        reset()
      default:
        print("current state must be running or pause. it is \(state)")
    }
  }
  ...
  public func resume() {
    switch state {
      case .pause:
        state = .running
      default:
        print("current state must be pause. it is \(state)")
    }
  }
  ...
  public func pause() {
    switch state {
      case .running:
        state = .pause
      default:
        print("current state must be running. it is \(state)")
    }
  }
